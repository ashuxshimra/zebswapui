  ...
  return (
    <div className="min-h-screen bg-background-dark flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center py-6 overflow-x-hidden">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-center mt-8 mb-2 px-4" style={mainTitleStyle}>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8 w-full justify-center px-4">
          <div className="px-5 py-2 rounded-full flex items-center" style={statBadgeStyle}>
      ...
      <div className="fixed bottom-8 right-8">
        <button 
          className="w-12 h-12 rounded-full flex items-center justify-center hover:opacity-90 transition-colors"
